...
export const STORE = {
  itens: [
    { id:1, name:'Colete de Couro', price:800, defense:5, description:'Proteção leve para o torso. (+5% Defesa)' },
    { id:2, name:'Luvas de Trabalho', price:500, boost:0.05, description:'Protege as mãos. (+5% de bônus no .work)' },
    { id:3, name:'Poção de HP Pequena', price:600, hpRestore:0.2, description:'Curativo rápido. (Recupera 20% da vida)' },
    { id:4, name:'Curativo Rápido', price:500, hpRestore:0.15, description:'Estanca sangramentos simples em batalhas.' },
    { id:5, name:'Corda de Nylon', price:700, exploreBoost:0.10, description:'Facilita a descida em masmorras ou cavernas.' },
    { id:6, name:'Vassoura de Palha', price:400, boost:0.02, description:'Aumenta ganhos em trabalhos braçais. (+2%)' },
    { id:7, name:'Armadura de Ferro', price:3500, defense:10, description:'Resistência sólida contra golpes. (+10% Defesa)' },
    { id:8, name:'Escudo de Bronze', price:2800, defense:8, description:'Chance de bloquear ataques físicos. (+8%)' },
    { id:9, name:'Picareta de Ferro', price:4200, power:10, mineBoost:0.10, description:'Melhora a extração de minérios. (+10% no .minerar)' },
    { id:10, name:'Machado de Aço', price:4200, power:14, workBoost:0.10, description:'Corta madeira com mais facilidade. (+10% no trabalho)' },
    { id:11, name:'Rede de Caça', price:3200, huntBoost:0.15, description:'Aumenta a chance de capturar animais. (+15% no .cacar)' },
    { id:12, name:'Antídoto Geral', price:2000, special:'antidoto', description:'Remove qualquer efeito de veneno do corpo.' },
    { id:13, name:'Manto de Fluxo', price:9000, agilityBoost:0.10, description:'Tecido leve que ajuda a desviar. (+10% Agilidade)' },
    { id:14, name:'Enxada de Prata', price:7500, plantBoost:0.15, description:'Melhora o rendimento da horta. (+15% no .plantar)' },
    { id:15, name:'Suco de Mochi', price:7000, energyRestore:0.5, description:'O lanche favorito do Gojo. (Recupera 50% de Energia)' },
    { id:16, name:'Kit Investigação', price:11000, exploreBoost:0.20, description:'Aumenta sucesso em buscas. (+20% em .explorar)' },
    { id:17, name:'Vara de Pesca Pro', price:8500, huntBoost:0.20, description:'Fisga peixes raros com mais facilidade. (+20%)' },
    { id:18, name:'Bota de Mercenário', price:13000, escapeBoost:0.15, description:'Melhora a velocidade de fuga. (+15% Escape)' },
    { id:19, name:'Cota de Malha Real', price:25000, defense:15, description:'Proteção de cavaleiro. (+15% Defesa total)' },
    { id:20, name:'Armadura de Placas', price:35000, defense:25, description:'Quase impenetrável. (+25% Defesa total)' },
    { id:21, name:'Maleta Executiva', price:40000, salarioBoost:0.20, description:'Aumenta o prestígio e o salário. (+20% no .salario)' },
    { id:22, name:'Notebook Gamer', price:30000, workBoost:0.20, description:'Aumenta a eficiência em código. (+20% no trabalho)' },
    { id:23, name:'Picareta de Diamante', price:55000, power:30, mineBoost:0.35, description:'Extrai joias lendárias. (+35% no .minerar)' },
    { id:24, name:'Poção de HP Grande', price:20000, hpRestore:1, description:'Regeneração total. (Cura 100% da vida)' },
    { id:25, name:'Manto do Vazio', price:150000, special:'invisible', escapeBoost:0.20, description:'Difícil de ser tocado. (+20% de Esquiva real)' },
    { id:26, name:'Escudo de Obsidiana', price:180000, defense:20, special:'immuneFire', description:'Proteção extrema. (Torna você imune a fogo)' },
    { id:27, name:'Traje de Sombra', price:250000, special:'invisible', escapeBoost:0.20, description:'Fica invisível por 3 turnos (Escapa de lutas)' },
    { id:28, name:'Amuleto de Vida', price:400000, special:'revive', description:'Uma segunda chance. (Renasce 1x se morrer)' },
    { id:29, name:'Frasco Adrenalina', price:110000, special:'adrenalina', description:'Impulso de poder. (Dobra o seu Dano por 3 rodadas)' },
    { id:30, name:'Elixir de Satoru', price:999999, special:'maxstatus', description:'Poder absoluto. (Todos os Status no Máximo)' }
  ],
  util: [
